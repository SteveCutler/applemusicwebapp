...
router.get('/episodes/:podcastId', protectRoute_js_1.default, podcast_controller_js_1.fetchEpisodes);
...
router.get('/recent-episodes', protectRoute_js_1.default, podcast_controller_js_1.fetchRecentEpisodes);
...
// https://mus-backend-b262ef3b1b65.herokuapp.com/api/podcast/get-subs
router.get('/episodes/:feedId', podcast_controller_js_1.getEpisodesByFeedId);

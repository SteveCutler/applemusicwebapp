...
const EditPlaylist = () => {
    ...
    const { playlistData, playlistTrackData, loading } =
    ...
    const [playlistTracks, setPlaylistTracks] = useState<Array<Song> | null>(
        null
    )
    ...
    useEffect(() => {
        ...
        if (playlistTrackData && !playlistTracks) {
            setPlaylistTracks(playlistTrackData)
        }

        return () => clearTimeout(delayDebounceFn)
    }, [searchTerm, musicKitInstance, playlistTrackData])
    ...
    return (
        <div className=" inset-0 flex text-black flex-col w-full items-center justify-center ">
            <h2 className="text-5xl font-bold mb-10">Edit Playlist</h2>
            <form className="w-1/2 pb-10">
                <div className="mb-4 gap-4 ">
                    ...
                    <input
                        ...
                        value={playlistData?.attributes.name}
                    />
                    <label
                    ...
                    <input
                        ...
                        value={playlistData?.attributes.description}
                    />
                </div>
            </form>

    ...
    return (
        <div className="w-full ">
            {podcast ? (
                ...
                >
                    <h2 className=" px-5 italic text-xl font-bold">
                        Recent Podcasts
                    </h2>
                </div>
            ) : object &&
              ...
              object.attributes.title.contentIds ? (
                ...
                <div
                    className={`text-lg font-bold w-11/12 border-b-2 pb-2 mb-4 flex mx-auto ${darkMode ? 'text-white border-white' : 'text-black border-black'}`}
                >
                    <h2 className=" px-5 text-xl italic font-bold">
                        {object.attributes.title.stringForDisplay}
                    </h2>
                </div>
            ) : (
            ...
            {object && (
                <div className="flex flex-col mb-10  rounded-xl w-full">
                    {podcastShow ? (
                        ...
                        <div className=" flex flex-wrap px-2 justify-center w-full mx-auto gap-x-1">
                            {object
                                // .slice(0, 15)
                                .slice(0, expand ? object.length : sliceNumber)
                                .map(item =>
                    ...
                    {object && object.length > sliceNumber && (
                        <button
                            ...
                            className={` hidden  rounded-b-lg ${queueToggle ? 'w-10/12 lg:w-8/12' : 'w-10/12  lg:w-4/12'} mx-auto md:flex justify-center items-center flex-col mb-2 mt-3 bg-blue-500 hover:bg-blue-400 active:bg-blue-600`}
                        >
                            {expand ? (
